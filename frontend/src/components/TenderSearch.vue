...
<template>
  ...
  <div class="search-container">
   <h2 class="title">Rechercher un appel d’offre</h2>
    ...
    <p v-else class="no-results">Aucun appel d’offre trouvé.</p>
  </div>
</template>
<script setup>
...
// Liste des appels d’offres (exemple, à remplacer par une requête API)
const tenders = ref([
  ...
  { id: 3, title: 'Travaux de rénovation', wilaya: 'Blida', company: 'anpt' }
]);
// Variables réactives
