  ...
  public function index()
{
    ...
    {
        // Retrieve the tender along with its related entreprise data
        $tender = AppelOffre::with('entreprise')->find($id);
        
        if (!$tender) {
            return response()->json(['message' => 'Appel d\'offre not found'], 404);
        }
